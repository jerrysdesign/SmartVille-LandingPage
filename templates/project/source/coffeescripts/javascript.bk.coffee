...
$("nav a").on "click", (e) ->
	e.preventDefault()
	$("html,body").stop().animate scrollTop: getRelatedContent(this).offset().top - 50
	, 800, "easeInOutQuint"
...
$(".section").waypoint((direction) ->
	getRelatedNavigation(this).toggleClass "active", direction is "down"
	$(this).toggleClass "current", direction is "down"
	console.log (direction)
,
	offset: 154
).waypoint ((direction) ->
	getRelatedNavigation(this).toggleClass "active", direction is "up"
	$(this).toggleClass "current", direction is "down"
	console.log (direction)
),
	offset: ->
